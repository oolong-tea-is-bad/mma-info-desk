...
const styles = StyleSheet.create({
  safeAreaView: {height: '100%', backgroundColor: Colors.white, padding: 10},
  wlecomeText: {fontWeight: 'bold', fontSize: 18, textAlign: 'center'},
  ...
  button: {borderWidth: 1, padding: 10, marginTop: 20, width: 100, alignItems: 'center',
    backgroundColor: Colors.blue500, borderRadius: 5
  },
})
